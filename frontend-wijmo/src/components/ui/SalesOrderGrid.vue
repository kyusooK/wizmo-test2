<template>
    <div style="max-height:80vh;">
        <div class="gs-bundle-of-buttons" style="max-height:10vh;">
                ...
                <v-btn @click="openCancelOrder" small color="primary" >
                    <v-icon small>mdi-minus-circle-outline</v-icon>cancelOrder
                </v-btn>
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','salesOrderNumber','salesPerson','salesType','companyId','salesItems','status',]" />
...
export default {
    ...
    methods:{
        ...
        cancelOrder(params){
            try{
                this.repository.invoke(this.getSelectedItem(), "cancelOrder", params)
                this.$mainApp.success("cancelOrder 성공적으로 처리되었습니다.")
            }catch(e){
                this.$mainApp.error(e)
            }
        },
